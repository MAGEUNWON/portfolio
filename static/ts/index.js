...
var components_js_1 = require("./components/components.js");
...
var routes = [
    // { path: "", component: Home },
    { path: "Planet", component: components_js_1.Planet },
];
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                component = ((_d = routes.find(function (route) { return route.path === hash_1; })) === null || _d === void 0 ? void 0 : _d.component) || components_js_1.NotFound;
